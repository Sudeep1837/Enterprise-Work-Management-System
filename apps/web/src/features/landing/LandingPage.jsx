    ...
    <div className="relative min-h-screen bg-slate-950 font-sans text-slate-50 selection:bg-indigo-500/30 overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative isolate overflow-hidden rounded-3xl bg-slate-900 px-6 py-24 text-center shadow-2xl border border-white/10"
        >
          ...
          <div className="mt-10 flex items-center justify-center gap-6">
            ...
            <a href="/login" className="text-sm font-semibold text-white hover:text-indigo-300 transition">
      ...
      <footer className="border-t border-white/8 bg-slate-950 py-10 text-center text-sm text-slate-600">
